...
set :application, 'qa-ate-editor'
set :repo_url, 'put_repo_url_here'

set :deploy_to, '~/rails_apps/qa-ate-editor'

# set :branch, 'master'
set :branch, 'release'

set :rvm_ruby_version, '2.3.1@qa-ate-editor'
...
namespace :deploy do
  ...
  task :update_config_file do
    on roles(:app) do
      execute "git archive --remote=ssh://git_url_here:10022/icl-upgrade/icl-secrets.git HEAD webta/ate-qa/application.yml | tar -xO > #{deploy_to}/shared/config/application.yml"
    end
  end
