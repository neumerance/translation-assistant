...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: 'qawebta.icanlocalize.com' }
  ...
  config.logger = GELF::Logger.new('192.168.1.83', 12201, 'WAN', facility: "icl-webta-#{Rails.env}")
